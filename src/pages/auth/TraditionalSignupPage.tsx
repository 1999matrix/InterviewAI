...
import { UserPlus, User, Lock, Mail, ArrowRight, CheckCircle, Eye, EyeOff } from 'lucide-react';
import { useTraditionalAuth } from '../../contexts/TraditionalAuthContext';
import Button from '../../components/ui/Button';

const TraditionalSignupPage: React.FC = () => {
  ...
  const { register, loginWithGoogle, loginWithGitHub, isAuthenticated } = useTraditionalAuth();
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium text-gray-900">Security</span>
            </div>
          </div>
        </div>
...
export default TraditionalSignupPage;
